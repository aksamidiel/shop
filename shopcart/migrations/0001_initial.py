    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_date', models.DateTimeField(auto_now=True, verbose_name='Дата последнего изменения')),
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_cart', to='shopcart.Cart', verbose_name='Корзина')),
                ('escooter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='escooter_in_cart', to='escooter.EScooter', verbose_name='Заказ')),
            ],
            options={
                'verbose_name': 'Заказ',
